...
namespace Stock历史龙虎榜指定日期单只上榜股
{
    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            FileStream fileStream = new FileStream(@"C:\LSLHB.txt", FileMode.OpenOrCreate);
            ...
            while ((c = sr.ReadLine()) != null)
            {
                ...
                {
                    FileHelper.WriteLine(@"C:/LSLHBException2.txt",c.Split('_')[0] + "_" + c.Split('_')[1] );
                    Thread.Sleep(1000*5);
                }
